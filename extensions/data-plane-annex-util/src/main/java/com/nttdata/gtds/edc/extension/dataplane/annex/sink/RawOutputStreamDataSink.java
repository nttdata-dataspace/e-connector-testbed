 ...
 */
public class RawOutputStreamDataSink implements DataSink {
    private final String requestId;
    private final ByteArrayOutputStream stream;
    private final ExecutorService executorService;
    private final Monitor monitor;

    public RawOutputStreamDataSink(String requestId, ExecutorService executorService, Monitor monitor) {
        ...
        try (var partStream = streamResult.getContent()) {
            return partStream
                    ...
                    .thenApply(results -> {
                        ...
                        return StreamResult.success(stream.toByteArray());
                    });
        } catch (Exception e) {
